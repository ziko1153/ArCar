...
<form method="post" class="form-horizontal" id="sample_form">
        ...
        <div class="form-group row">
            <label class="col-form-label col-lg-2">Customer NI:</label>
            <div class="col-lg-10">
                <div class="form-group-feedback form-group-feedback-right">
                <input type="text" class="form-control " placeholder="Enter National Insurance" name="cust_ni" value="">
        ...
        $(document).on('click','.edit',function(){
              ...
              let  id = $(this).attr('id');
                ...
                success:function(data)
                {
                    ...
                    $("input[name*='cust_ni']").val(data.result.cust_ni);
