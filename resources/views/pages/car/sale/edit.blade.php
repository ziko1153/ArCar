            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="input-group ml-3 mb-2">
                        ...
                        <input  autocomplete="off" type="text" class="form-control mr-4"  id="carSearch" placeholder="Search Car By 'Name' or 'Reg No' or 'Auction Name'">
                    </div>
                ...
                <div class="col-md-6">
                    <div class="input-group ml-3">
                        ...
                        <input  autocomplete="off" type="text" class="form-control mr-4 daterange-single "  id="saleDate" value="">
                    </div>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="input-group ml-3 mb-3">
                        ...
                        <input  autocomplete="off" type="text" class="form-control mr-4 checkForDot" id="paymentInp"  value="0"   placeholder="Enter Payment">
                    </div>
                ...
                <div class="col-md-6">
                    <div class="input-group ml-3 mb-3">
                        ...
                        <input  autocomplete="off" type="text" class="form-control mr-4 checkForDot" id="discountInp" value="0"   placeholder="Enter Disocunt Amount">
                    </div>
...
if(!checkExistInCart(data.id)){
    ...
    pAlertError('Error','Same Car Already Exists into The Cart')
}
